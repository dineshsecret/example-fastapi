...
SECRET_KEY = settings.secret_key #"1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZ"
ALGORITHM = settings.algorithm #"HS256"
ACCESS_TOKEN_MINUTES = settings.access_token_expire_min #60 moved all these configs to .env and config.py
